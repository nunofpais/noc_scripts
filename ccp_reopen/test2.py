...
from scripts.nunopais.test2.cases2 import (  # add_internal_note
    get_cases_24hrs,
...
#     674316064776376,
# ]
# ui_cases = [693541862686900, 674500714702592, 267049606163968]

# ui_cases = [886404976331464]
...
for case in ui_cases:
    ...
    # Get case owner
    # case_owner = get_full_name(cases_df[cases_df["fbid"] == case]["owner_id"].values[0])
    # print(f"Case Owner: {case_owner}\n")
    ...
    if len(nwt_matches) == 0 and len(task_matches) == 0 and len(sev_matches) == 0:
        ...
        if (
            ...
            if len(tasks_closed) == len(task_matches) and len(sevs_closed) == len(
                ...
                # addCommentToDSTicket(case, "EFSupdate@meta.com", update_no_comments, "REOPENED")
